...
def process_json(input_json):
    ...
    for item_id, item in enumerate(input_json):
        ...
        if item_id % 10 == 0 or item_id == 1:
            ...
            json.dump(input_json, open("rocult_classification_claude.json", "w", encoding="utf-8"), indent=4, ensure_ascii=False)
        label = classify(item)
...
if __name__ == "__main__":
    ...
    json.dump(dataset, open("rocult_classification_claude.json", "w", encoding="utf-8"), indent=4, ensure_ascii=False)